      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <div className="flex space-x-4">
            <a href="#" className="hover:text-blue-300"><Facebook className="premium-icon" /></a>
            <a href="#" className="hover:text-blue-300"><Twitter className="premium-icon" /></a>
            <a href="#" className="hover:text-blue-300"><Instagram className="premium-icon" /></a>
            <a href="#" className="hover:text-blue-300"><Linkedin className="premium-icon" /></a>
          </div>
        </div>
      </div>
