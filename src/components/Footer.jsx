  ...
  <footer className="bg-black text-white py-8 md:py-12 px-4 md:px-8">
    <div className="max-w-6xl mx-auto">
      <div className="text-center">
        <h3 className="text-lg md:text-xl font-semibold mb-3 md:mb-4 text-gray-300">ComicFix</h3>
        ...
        <div className="bg-gray-800 text-white p-4 rounded-lg mb-6">
          <p className="mb-4">We are committed to maintaining a welcoming and inclusive community for developers.</p>
          <Button
